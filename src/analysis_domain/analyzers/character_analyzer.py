...
class CharacterAnalyzer(BaseAnalyzer):
    ...
    def display_name(self) -> str:
        ...
        return "Анализ персонажей"

    @property
    def description(self) -> str:
        """Описание анализатора"""
        return "Анализирует персонажей произведения: извлекает имена, роли, черты характера и развитие"
    ...
    def _format_character_prompt(self, chunk_text: str, context: str = "") -> str:
        ...
        # Обогащенные списки черт характера для лучшего анализа
        character_traits_examples = [
            # Положительные черты
            "мужественный", "храбрый", "честный", "добрый", "справедливый", "умный", "мудрый",
            "щедрый", "терпеливый", "верный", "преданный", "трудолюбивый", "скромный",
            "отзывчивый", "благородный", "великодушный", "бескорыстный", "решительный",
            "целеустремленный", "настойчивый", "оптимистичный", "жизнерадостный",
            "дружелюбный", "гостеприимный", "тактичный", "деликатный", "вежливый",
            "образованный", "талантливый", "творческий", "изобретательный", "находчивый",
            "ответственный", "надежный", "пунктуальный", "организованный", "дисциплинированный",

            # Отрицательные черты
            "жестокий", "злой", "подлый", "коварный", "лживый", "хитрый", "завистливый",
            "жадный", "эгоистичный", "высокомерный", "гордый", "тщеславный", "надменный",
            "ленивый", "безответственный", "беспечный", "легкомысленный", "наивный",
            "трусливый", "слабый", "нерешительный", "сомневающийся", "пессимистичный",
            "мрачный", "угрюмый", "замкнутый", "нелюдимый", "грубый", "невоспитанный",
            "агрессивный", "вспыльчивый", "раздражительный", "нетерпеливый", "импульсивный",
            "упрямый", "настырный", "капризный", "избалованный", "требовательный",

            # Нейтральные и сложные черты
            "задумчивый", "мечтательный", "романтичный", "чувствительный", "эмоциональный",
            "спокойный", "уравновешенный", "хладнокровный", "рассудительный", "практичный",
            "амбициозный", "властный", "независимый", "свободолюбивый", "бунтарский",
            "любознательный", "пытливый", "наблюдательный", "внимательный", "проницательный",
            "осторожный", "предусмотрительный", "недоверчивый", "подозрительный", "скрытный",
            "общительный", "разговорчивый", "красноречивый", "убедительный", "харизматичный",
            "консервативный", "традиционный", "прогрессивный", "новаторский", "экспериментальный"
        ]
...
Примеры черт характера: {', '.join(character_traits_examples[:30])}...
